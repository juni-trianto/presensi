            ...
            <div class="col-md-12">
                <div class="card card-light">
                    <div class="card-body curves-shadow">
                        <h2><b>ABSEN MASUK</b> | TANGGAL = <?= date('d F Y', strtotime(date('Y-m-d'))); ?> | Status = <?= $this->session->userdata('status_absen_masuk');  ?></h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="jenis_absen">Pilih Jenis Absen</label><br>
                                        <select class="custom-select my-1 mr-sm-2" name="jenis_absen" id="jenis_absen" required>
                                            <option value="">---</option>
